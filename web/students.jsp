        ...
        <form action="CalculateGrades" method="post" name="calcgrades" id="calcgrades">
            <table width="600px" border="0" >
                ...
                <tr>
                    ...
                    <td><input name="lastname" id="lastname" type="text" size="30" style="background-color:#FAFAD2"></td>
                    <td><input name="firstname" id="firstname" type="text" size="30" style="background-color:#FAFAD2"></td>
                </tr>
            </table><br />
            <table width="775px" border="0" cellspacing="1" >
                ...
                <tr>
                    ...
                    <td><input name="q2" id="q2" type="text" size="10" style="background-color:#FAFAD2"></td>
                    <td><input name="q3" id="q3" type="text" size="10" style="background-color:#FAFAD2"></td>
                    <td><input name="q4" id="q4" type="text" size="10" style="background-color:#FAFAD2"></td>
                    <td><input name="q5" id="q5" type="text" size="10" style="background-color:#FAFAD2"></td>
                    <td><input name="qmkup" id="qmkup" type="text" size="10" style="background-color:#FAFAD2"></td>
                </tr>
            </table><br/>
